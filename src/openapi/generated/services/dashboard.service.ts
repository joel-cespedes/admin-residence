...
[key: string]: any;
   ...
   *
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `getTaskCategoriesDashboardTaskCategoriesGet$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  getTaskCategoriesDashboardTaskCategoriesGet(params?: {
    'X-Residence-Id'?: (string | null);
  }, context?: HttpContext): Observable<TaskCategoryWithCount[]> {
    return this.getTaskCategoriesDashboardTaskCategoriesGet$Response(params, context).pipe(
      map((r: StrictHttpResponse<TaskCategoryWithCount[]>): TaskCategoryWithCount[] => r.body)
    );
  }
   ...
   *
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `getTaskCategoriesDashboardTaskCategoriesGet()` instead.
   *
   * This method doesn't expect any request body.
   */
  getTaskCategoriesDashboardTaskCategoriesGet$Response(params?: {
    'X-Residence-Id'?: (string | null);
  }, context?: HttpContext): Observable<StrictHttpResponse<TaskCategoryWithCount[]>> {
    const rb = new RequestBuilder(this.rootUrl, DashboardService.getTaskCategoriesDashboardTaskCategoriesGetPath, 'get');
    if (params) {
    ...
    return this.http.request(
      ...
      map((r: HttpResponse<any>) => {
        return r as StrictHttpResponse<TaskCategoryWithCount[]>;
      })
    );
  }

  static readonly getTaskCategoriesDashboardTaskCategoriesGetPath = '/dashboard/task-categories';
